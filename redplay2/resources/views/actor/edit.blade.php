...
<div class="create-header">
  <div class="welcome">Edit Aktor</div>
...
<div class="create-wrap">
  ...
  <div class="panel">
    ...
    <div class="panel-body">
      <form action="{{ route('actors.update', $actor->id_aktor) }}" method="POST">
        @csrf
        @method('PUT')

        <div class="fg">
          <label>Nama Aktor</label>
          <input type="text" name="namaaktor" placeholder="Contoh: Tom Cruise, Reza Rahadian..." value="{{ old('namaaktor', $actor->namaaktor) }}" required autofocus>
        </div>
