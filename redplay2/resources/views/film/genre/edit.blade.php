...
<div class="create-header">
  <div class="welcome">Edit Genre</div>
    ...
    <div class="panel-body">
      <form action="{{ route('genres.update', $genre->id_genre) }}" method="POST">
        ...
        <div class="fg">
          ...
          <input type="text" name="genre" placeholder="Contoh: Action, Horor, Sci-Fi..." value="{{ old('genre', $genre->genre) }}" required autofocus>
        </div>

        <div class="form-actions">
          <a href="{{ route('genres.manage') }}" class="btn-back">
