...
<head>
    ...
    <title>Daftar — {{ config('app.name', 'FilmApp') }}</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Curved dark shape on the LEFT edge */
        .right-panel::after {
            content: '';
            position: absolute;
            top: -10%;
...
<div class="card">
    ...
    <div class="left-panel">
        <h1>Buat Akun</h1>
        <p class="subtitle">Daftar dan mulai menonton sekarang</p>
        ...
        <p class="social-label">Atau daftar dengan</p>
    ...
    <div class="right-panel">
        <div class="right-logo">FILM<span>APP</span></div>
        <h2>Welcome Back!</h2>
